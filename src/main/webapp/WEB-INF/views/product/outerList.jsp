...
<link rel ="stylesheet" type="text/css" href="${ pageContext.servletContext.contextPath }/resources/css/outerList.css"/>
...
<body>
    ...
    <script>
     ...
     <div class="signbox"></div>
      ...
      <div class="product_list" id="outerList">
      <c:forEach items="${outerList}" var="p" varStatus="status">
        ...
        <c:if test="${(index + 1) % 4 == 0 || status.last}">
            </div>
        </c:if>
    </c:forEach>
      </div>
		...
		<script>
			...
			$(document).ready(function(){
				  $("#outerList .product1").click(function(){
