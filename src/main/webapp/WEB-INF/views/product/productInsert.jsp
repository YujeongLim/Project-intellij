...
<head>
<meta charset="UTF-8">
<title>LJSS INSERT PAGE</title>
<link rel ="stylesheet" type="text/css" href="${ pageContext.servletContext.contextPath }/resources/css/insert.css"/>
...
<body>
    ...
    <script>
        ...
        <div id = "wrap">
            <div class ="title" >
                <h3>INSERT YOUR PRODUCT HERE</h3>
            </div>
			
			<!-- 첨부파일도 등록할꺼니깐 Multipart/form-data encType 지정!! -->
            <form id="enrollForm" method="post" action="insertProduct" enctype="multipart/form-data">
               <div class="insert_form">
                <label class ="productname">
                    <ul class="name">PRODUCT NAME*</ul>
                    
                    <input type="text" id="name" class="form-control" name="proName" placeholder="&nbsp;&nbsp;&nbsp;PLEASE ENTER YOUR PRODUCT NAME"required>               
                 </label>
                <br>
                <label class = "prodcutprice" >
                    <ul id="word">PRODUCT PRICE*</ul>
                    
                    <input type="text" id="price" class="form-control" name="proPrice" placeholder="&nbsp;&nbsp;&nbsp;PLEASE ENTER YOUR PRODUCT PRICE"required>                
                </label> 
                ...
                <label class = "productstock" >
                    ...
                    <input type="text" id="stock" class="form-control" name="proStock" placeholder="&nbsp;&nbsp;&nbsp;PLEASE ENTER YOUR PRODUCT STOCK"required>                
                </label> 
                ...
                <label class = "catecode" >
                    ...
                    <input type="text" id="catecode" class="form-control" name="cateCode" placeholder="&nbsp;&nbsp;&nbsp;OUTER=1,TOP=2,BOTTOM=3,SHOES=4,ACC=5"required>                
                </label> 

                <br>
                <label class = "size" >
                    <ul id="word3">PRODUCT SIZE*</ul>
                    <select id="size" name="proSize"required>
                      <option value="" disabled selected>&nbsp;&nbsp;&nbsp;PLEASE CHOICE YOUR PRODUCT SIZE</option>
                ...
                <div class="thumbnail-file-area">
					<input type="file" id="thumbnailImg1" name="proImgs" onchange="loadImg(this,1)">
                    <input type="file" id="thumbnailImg2" name="proImgs" onchange="loadImg(this,2)">
