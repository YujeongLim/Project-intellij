...
<link rel ="stylesheet" type="text/css" href="${ pageContext.servletContext.contextPath }/resources/css/shoesList.css"/>
...
<body>
    ...
    <script>
     ...
     <div class="signbox"></div>
      ...
      <div class="product_list" id="shoesList">
      <c:forEach items="${shoesList}" var="p" varStatus="status">
		...
		<script>
			...
			$(document).ready(function(){
				  $("#shoesList .product1").click(function(){
