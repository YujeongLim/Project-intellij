...
<link rel ="stylesheet" type="text/css" href="${ pageContext.servletContext.contextPath }/resources/css/accList.css"/>
...
<body>
    ...
    <script>
     ...
     <div class="signbox"></div>
      ...
      <div class="product_list" id="accList">
      <c:forEach items="${accList}" var="p" varStatus="status">
		...
		<script>
			...
			$(document).ready(function(){
				  $("#accList .product1").click(function(){
