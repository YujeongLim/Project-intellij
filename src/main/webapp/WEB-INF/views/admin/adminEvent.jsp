    ...
    <div id="container">
        ...
        <div id="wrap">
            <div class="contents">
                ...
                <!-- 버튼박스 -->
                <div class="bnt_box">
                    <a class="add_btn" href="eventInsertForm">이벤트추가</a>
                    <button class="delete_btn"><a href="#">선택삭제</a></button>
                </div>
                <table>
                    <thead>
                    <tr>
                  		<th><input type="checkbox" name="event_list"/></th>
                        <th>이벤트코드</th>
                        <th>이벤트명</th>
                        <th>이벤트상세</th>
                        <th>이벤트등록일</th>
                ...
                <tr>
                  	<td><input type="checkbox" name="event_list"/></td>
                    <td onclick="location.href='detailEvent?eno=${ e.eventCode }'">${ e.eventCode }</td>
                    <td>${ e.eventName }</td>
                    <td>${ e.eventDetail }</td>
                    <td>${ e.eventAddDate }</td>
                    <td><img src="${ pageContext.servletContext.contextPath }/resources/upload_files/${ e.eventPhoto }" style="width:200px; height:120px;"></td>
                </tr>
                </c:forEach>
        		</tbody>
                </table>
