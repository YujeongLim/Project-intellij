...
<form action="updateEvent" method="post" enctype="multipart/form-data">
                <table style="text-align:center; width: 97%; margin: 0 auto;">
                    ...
                    <tbody>
                <tr>
                    <td><input type="text" name="eventCode" style="width:100%; border:none;  padding:10px; text-align:center;" value="${ e.eventCode }"></td>
                    <td><input type="text" name="eventName" style="width:100%;" value="${ e.eventName }"></td>
                    <td><input type="text" name="eventDetail" style="width:100%; padding:10px;" value="${ e.eventDetail }"></td>
                    <td><input type="date" name="eventAddDate" style="width:100%; text-align:center;" value="${ e.eventAddDate }"></td>
                    <td><input type="file" name="reUploadFile" style="width:100%; text-align:center;" value="${ e.eventPhoto }"></td>
                </tr>
       		 	</tbody>
                </table>
                
                <div class="back_btn" onclick="history.back()" style="margin-left: 20px;">◀ 뒤로가기</div>
                 <div class="fr">
                    <input type="submit" class="btn_box" value="수정하기" style="padding: 8px;">
                    <button class="btn_box" onclick="location.href='deleteEvent?eno=${ e.eventCode }'">삭제하기</button>
                </div>
</form>                
